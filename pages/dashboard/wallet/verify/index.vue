<template>
  <div class="wallet_verify">
    ...
    <div class="form">
      <img src="@image/icons/block.svg" alt="" />
      <div class="quote">
        Please complete the account verification process to unlock your wallet
      </div>
      <vs-button class="btn_verify" color="#0b9985" type="submit"> Verify </vs-button>
    </div>
  </div>
</template>
